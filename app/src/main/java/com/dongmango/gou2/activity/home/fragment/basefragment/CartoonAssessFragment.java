...
public class CartoonAssessFragment extends HeaderViewPagerFragment {
    public static final String TAG = CartoonAssessFragment.class.getSimpleName();
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_cartoonassess);
