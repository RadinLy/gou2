...
public class SheetFragment extends Fragment {
    ...
    public static SheetFragment newGridInstance(String title, String[] items, int[] images) {
        SheetFragment fragment = new SheetFragment();
        Bundle bundle = new Bundle();
        bundle.putString("title", title);
        bundle.putStringArray("items", items);
...
//            }
            ...
            TextView pop_cancel = (TextView) view.findViewById(R.id.pop_cancel2);
            pop_cancel.setVisibility(View.VISIBLE);
            pop_cancel.setText("取消");
            pop_cancel.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            GridViewAdapter adapter = new GridViewAdapter(getActivity(), getArguments().getStringArray("items"), getArguments().getIntArray("images"));
            pop_grid.setAdapter(adapter);
    ...
    public static class Builder {
        ...
        public void show() {
            ...
            if (choice == CHOICE.GRID) {
                fragment = SheetFragment.newGridInstance(title, items, images);
                fragment.setOnItemClickListener(onItemClickListener);
                fragment.setOnCancelListener(onCancelListener);
                fragment.show(fragmentManager, tag);
            }
