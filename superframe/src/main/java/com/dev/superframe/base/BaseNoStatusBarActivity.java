...
import com.dev.superframe.view.dialog.LoadingDialog;
 ...
 * @see #onDestroy
 */
public abstract class BaseNoStatusBarActivity extends FragmentActivity implements ActivityPresenter {
    ...
    public void setContentView(int layoutResID) {
        ...
        SystemBarTintUtil.setSystemBarTint(getActivity(), R.color.transparent);
        SystemBarTintUtil.setSystemBarUiIcon(getActivity());
