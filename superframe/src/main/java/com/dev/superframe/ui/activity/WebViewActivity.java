...
public class WebViewActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_webview);//传this是为了全局滑动返回
    ...
    public void initView() {
        ...
        pbWebView.setProgressDrawable(this.getResources().getDrawable(R.drawable.progress_color_horizontal));
    }
