package com.dev.superframe.ui.activity;
 ...
 */
public class ImagePagerActivity extends BaseNoStatusBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewPager viewPager = (ViewPager) findViewById(R.id.vp_display);
    ...
    private void addGuideView(LinearLayout guideGroup, int startPos, ArrayList<String> imgUrls) {
        if (imgUrls != null && imgUrls.size() > 0) {
            ...
            for (int i = 0; i < imgUrls.size(); i++) {
                ...
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(DensityUtil.dip2px(getActivity(), 3), DensityUtil.dip2px(getActivity(), 3));
    ...
    private static class ImageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            View view = inflater.inflate(R.layout.item_imagepager, container, false);
            if (view != null) {
                ...
                Glide.with(context)
                        ...
                        .error(R.drawable.icon_image_err)
